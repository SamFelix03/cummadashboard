...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$next$2d$auth$2f$mongodb$2d$adapter$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@next-auth/mongodb-adapter/dist/index.js [app-route] (ecmascript)");
...
;
const authOptions = {
    adapter: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$next$2d$auth$2f$mongodb$2d$adapter$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MongoDBAdapter"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["clientPromise"]),
    providers: [
...
"[project]/src/models/Facility.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__ = __turbopack_import__("[externals]/mongoose [external] (mongoose, cjs)");
;
const labEquipmentSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Schema({
    labName: {
        type: String,
        required: true
    },
...
const softwareEquipmentSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Schema({
    softwareName: {
        type: String,
        required: true
    },
...
const saasEquipmentSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Schema({
    equipmentName: {
        type: String,
        required: true
    },
...
const areaDetailsSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Schema({
    area: {
        type: Number,
        required: true
    },
...
const rentalPlanSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Schema({
    name: {
        type: String,
        enum: [
            'Annual',
...
const baseDetailsSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Schema({
    name: {
        type: String,
        required: true
    },
    ...
    rentalPlans: {
        ...
        validate: [
            ...
            'At least one rental plan is required'
        ]
    }
});
const facilitySchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Schema({
    serviceProviderId: {
            ...
            validator: function(details) {
                ...
                switch(doc.facilityType){
                    case 'individual-cabin':
                        return typeof details.totalCabins === 'number' && typeof details.availableCabins === 'number';
                    case 'coworking-spaces':
                        return typeof details.totalSeats === 'number' && typeof details.availableSeats === 'number';
                    case 'meeting-rooms':
                        return typeof details.totalRooms === 'number' && typeof details.seatingCapacity === 'number' && typeof details.totalTrainingRoomSeaters === 'number';
                    case 'bio-allied-labs':
                    case 'manufacturing-labs':
                    case 'prototyping-labs':
                        return Array.isArray(details.equipment) && details.equipment.length > 0 && details.equipment.every((eq)=>eq.labName && eq.equipmentName && eq.capacityAndMake);
                    case 'software':
                        return Array.isArray(details.equipment) && details.equipment.length > 0 && details.equipment.every((eq)=>eq.softwareName && eq.version);
                    case 'saas-allied':
                        return Array.isArray(details.equipment) && details.equipment.length > 0 && details.equipment.every((eq)=>eq.equipmentName && eq.capacityAndMake);
                    case 'raw-space-office':
                    case 'raw-space-lab':
                        return Array.isArray(details.areaDetails) && details.areaDetails.length > 0 && details.areaDetails.every((area)=>typeof area.area === 'number' && [
                                'Covered',
                                'Uncovered'
                            ].includes(area.type) && [
                                'Furnished',
                                'Not Furnished'
                            ].includes(area.furnishing) && [
                                'Open to Customisation',
                                'Cannot be Customised'
                            ].includes(area.customisation));
                    default:
                        return false;
                }
            },
...
const __TURBOPACK__default__export__ = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].models['Facilities'] || __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].model('Facilities', facilitySchema, 'Facilities');
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/lib/db.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Facility$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/models/Facility.ts [app-route] (ecmascript)");
    ...
    try {
        ...
        const facilityData = {
            ...
            details: {
                ...
                rentalPlans: data.rentalPlans.map((plan)=>({
                        name: plan.name,
                        price: plan.price,
        ...
        switch(data.type){
            ...
            case 'manufacturing-labs':
            case 'prototyping-labs':
                facilityData.details.equipment = data.equipment.map((eq)=>({
                        labName: eq.labName,
            ...
            case 'raw-space-office':
            case 'raw-space-lab':
                facilityData.details.areaDetails = data.areaDetails.map((area)=>({
                        area: area.area,
                        type: area.type,
            ...
            case 'saas-allied':
                ...
                break;
            case 'individual-cabin':
                facilityData.details.totalCabins = data.totalCabins;
                facilityData.details.availableCabins = data.availableCabins;
                break;
            case 'coworking-spaces':
                facilityData.details.totalSeats = data.totalSeats;
                facilityData.details.availableSeats = data.availableSeats;
                break;
            case 'meeting-rooms':
                facilityData.details.totalRooms = data.totalRooms;
                facilityData.details.seatingCapacity = data.seatingCapacity;
                facilityData.details.totalTrainingRoomSeaters = data.totalTrainingRoomSeaters;
                break;
        }
        console.log('API Route - Creating facility with data:', JSON.stringify(facilityData, null, 2));
        const facility = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Facility$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create(facilityData);
...
async function GET() {
    try {
        ...
        const serviceProviderId = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](session.user.id);
        const facilities = await db.collection('Facilities').find({
            serviceProviderId
        }).sort({
            updatedAt: -1
        }).toArray();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(facilities);
    } catch (error) {
...
async function DELETE(request) {
    try {
        ...
        if (!id) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]('Facility ID is required', {
                status: 400
            });
        }
        const { db } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectToDatabase"])();
        ...
        if (result.deletedCount === 0) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]('Facility not found', {
                status: 404
            });
        }
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]('Facility deleted successfully');
    } catch (error) {
...
async function PATCH(request) {
    try {
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]('Facility updated successfully');
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__f2f9da._.js.map