  ...
  const handleNext = async () => {
    ...
    switch (activeTab) {
      ...
      case 'startup':
        ...
        break
      case 'additional':
        fieldsToValidate = ['startupMailId', 'sector', 'industry', 'stagecompleted', 'lookingFor', 'terms']
        break
    }
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <TabsContent value="additional" className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            {/* Industry, Sector, and Stage Section */}
            <div className="space-y-4">
              <h3 className="text-lg font-medium">Startup Details</h3>
              <div className="grid gap-4">
                <div className="space-y-2">
                  <Select onValueChange={handleIndustryChange} value={watch('industry')}>
                    <SelectTrigger className="h-12">
                ...
                <div className="space-y-2">
                  <Select onValueChange={handleSectorChange} value={watch('sector')}>
                    <SelectTrigger className="h-12">
                ...
                <div className="space-y-2">
                  <Select onValueChange={handleStageCompletedChange} value={watch('stagecompleted')}>
                    <SelectTrigger className="h-12">
