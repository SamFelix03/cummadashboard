...
export async function registerStartup(data: z.infer<typeof startupSignUpSchema>) {
  try {
    ...
    try {
      ...
      // Create startup using Mongoose model with all new fields
      ...
      const startup = await Startup.create([{
        ...
        dpiitNumber: data.dpiitNumber || null,
        industry: data.industry,
        sector: data.sector,
        stagecompleted: data.stagecompleted,
        startupMailId: data.startupMailId,
        website: data.website || null,
        linkedinStartupUrl: data.linkedinStartupUrl || null,
        linkedinFounderUrl: data.linkedinFounderUrl || null,
